...
public class GDD03 extends Activity {
        ...
        mButton01.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                if (refreshDisplay) {
                    ...
                    // TO DO
                    new DoQueryLatLngTask().execute(mEditText01.getText().toString());
                } else {
    ...
    private LatLng getLatLngByAddress(String strAddress) {
        ...
        try {
            ...
            ll = new LatLng(ad.getLatitude(), ad.getLongitude());
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            if (ll != null) {
                ...
                try {
                    ...
                    List<Address> lstAddress = gc.getFromLocation(geoLatitude, geoLongitude, 5);
